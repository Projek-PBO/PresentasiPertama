        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 13 :
                    ...
                    param1 = input.nextDouble();
                    System.out.print("Masukkan Tali Busur Tembereng : ");
                    param2 = input.nextDouble();
                    System.out.print("Masukkan jari-jari Tembereng : ");
                    param3 = input.nextDouble();
                    Tembereng tembereng = new Tembereng (param1, param2, param3);
                    tembereng.hitungLuasPermukaanTembereng();
                    tembereng.hitungVolumeTembereng();
                    tembereng.tampilkanInfo();
                    break;
                case 14 :
                    System.out.print("Masukkan Panjang Tali Juring : ");
                    param1 = input.nextDouble();
                    System.out.print("Masukkan Jari-Jari Lingkaran : ");
                    param2 = input.nextDouble();
                    Juring juring = new Juring(param1, param2);
                    juring.hitungLuasPermukaanJuring();
